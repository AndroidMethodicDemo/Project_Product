package com.jit.swip.widget;

import java.util.ArrayList;
import java.util.List;

import com.jit.swip.R;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    /**
     * 动态改变Activity的根节点，将原有的跟节点替换为SwipeBackLayout
     */
    public void attachToActivity(Activity activity) {
        ...
        addView(decorChild);// 将原来的跟节点添加到SwipeBackLayout下
        setContentView(decorChild);// 设置成员变量ContentView
        decor.addView(this);//将SwipeBackLayout添加为跟节点
    }
